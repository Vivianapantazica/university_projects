    ...
    class Camera2
    {
     public:
        ...
        void RotateFirstPerson_OX(float angle)
        {
            ...
            right = glm::normalize(glm::vec3(glm::rotate(glm::mat4(1.0f), angle, right) * glm::vec4(right, 0)));
        ...
        void RotateFirstPerson_OY(float angle)
        {
            ...
            right = glm::normalize(glm::vec3(glm::rotate(glm::mat4(1.0f), angle, glm::vec3(0, 1, 0)) * glm::vec4(right, 0)));
            up = glm::cross(right, forward);
        ...
        void RotateFirstPerson_OZ(float angle)
        {
            ...
            forward = glm::normalize(glm::vec3(glm::rotate(glm::mat4(1.0f), angle, forward) * glm::vec4(forward, 0)));
